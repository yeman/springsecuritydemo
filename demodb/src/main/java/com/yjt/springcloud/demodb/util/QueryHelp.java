package com.yjt.springcloud.demodb.util;
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                if (q != null) {
                    ...
                    String multiFieldLike = q.multiFieldLike();
                    ...
                    Join join = null;
                    // 模糊多字段
                    if (ObjectUtil.isNotEmpty(multiFieldLike)) {
                        String[] blurrys = multiFieldLike.split(",");
